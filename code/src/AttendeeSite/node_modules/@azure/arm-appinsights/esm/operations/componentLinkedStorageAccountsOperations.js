...
export { ComponentLinkedStorageAccountsOperations };
...
var createAndUpdateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.ComponentLinkedStorageAccounts), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ComponentLinkedStorageAccounts
...
var updateOperationSpec = {
    ...
    requestBody: {
        parameterPath: "linkedStorageAccountsProperties",
        mapper: __assign(__assign({}, Mappers.ComponentLinkedStorageAccountsPatch), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.ComponentLinkedStorageAccounts
